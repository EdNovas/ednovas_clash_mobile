...
class ApiService {
  ...
  ApiService() {
    ...
    // Set unified User-Agent for all requests
    _dio.options.headers['User-Agent'] = UserAgentService().userAgent;
  ...
  Future<Map<String, dynamic>> loginWithRetry(String email, String password,
    ...
    throw lastError ?? NetworkException('登录失败，请检查网络连接');
  }
